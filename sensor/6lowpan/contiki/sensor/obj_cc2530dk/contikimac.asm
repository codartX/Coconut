...
;------------------------------------------------------------
;mac_callback_ptr          Allocated to stack - sp -40
;buf_list                  Allocated to stack - sp -43
;mac_callback              Allocated to registers r5 r6 r7 
;t0                        Allocated to registers r6 r2 
;encounter_time            Allocated to stack - sp -34
;strobes                   Allocated to stack - sp -32
;got_strobe_ack            Allocated to registers r7 
;hdrlen                    Allocated to stack - sp -30
;len                       Allocated to registers r4 r5 
;is_broadcast              Allocated to stack - sp -28
;is_reliable               Allocated to registers 
;is_known_receiver         Allocated to stack - sp -27
;collisions                Allocated to stack - sp -26
;transmit_len              Allocated to stack - sp -25
;ret                       Allocated to registers r6 r7 
;contikimac_was_on         Allocated to registers r3 
;seqno                     Allocated to stack - sp -23
;chdr                      Allocated to registers r3 r6 r7 
;ptr                       Allocated to stack - sp -22
;i                         Allocated to stack - sp -19
;wt                        Allocated to registers r6 r2 
;txtime                    Allocated to stack - sp -17
;ret                       Allocated to registers 
;ackbuf                    Allocated to stack - sp -15
