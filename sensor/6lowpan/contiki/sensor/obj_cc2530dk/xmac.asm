...
;e                         Allocated to stack - sp -12
;packet                    Allocated to stack - sp -9
;is_already_streaming      Allocated to stack - sp -6
