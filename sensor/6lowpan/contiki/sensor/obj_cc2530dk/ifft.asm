...
;------------------------------------------------------------
;xim                       Allocated to stack - sp -60
;n                         Allocated to stack - sp -62
;xre                       Allocated to stack - sp -54
;nu                        Allocated to stack - sp -51
;n2                        Allocated to stack - sp -49
;nu1                       Allocated to registers r7 r5 
;p                         Allocated to stack - sp -47
;k                         Allocated to registers r3 r7 
;l                         Allocated to stack - sp -45
;i                         Allocated to stack - sp -43
;c                         Allocated to registers r7 r4 r3 r2 
;s                         Allocated to stack - sp -41
;tr                        Allocated to stack - sp -37
;ti                        Allocated to registers r7 r4 r3 r2 
;sloc0                     Allocated to stack - sp -33
;sloc1                     Allocated to stack - sp -31
;sloc2                     Allocated to stack - sp -29
;sloc3                     Allocated to stack - sp -27
;sloc4                     Allocated to stack - sp -25
;sloc5                     Allocated to stack - sp -22
;sloc6                     Allocated to stack - sp -18
;sloc7                     Allocated to stack - sp -14
;sloc8                     Allocated to stack - sp -11
;sloc9                     Allocated to stack - sp -7
;sloc10                    Allocated to stack - sp -3
;------------------------------------------------------------
