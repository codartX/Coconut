...
_eventhandler_p_1_1:
	.ds 3
_tcpip_ipv6_output_nbr_1_1:
	.ds 3
_tcpip_ipv6_output_nexthop_1_1:
	.ds 3
...
;nbr                       Allocated with name '_tcpip_ipv6_output_nbr_1_1'
;nexthop                   Allocated with name '_tcpip_ipv6_output_nexthop_1_1'
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/tcpip.c:548: static uip_ds6_nbr_t *nbr = NULL;
	mov	dptr,#_tcpip_ipv6_output_nbr_1_1
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/tcpip.c:115: tcpip_output(uip_lladdr_t *a)
;	-----------------------------------------
...
_tcpip_output:
	...
	mov	r6,dph
	mov	r7,b
;	../../../contiki-sensinode//core/net/tcpip.c:118: if(outputfunc != NULL) {
	...
	orl	a,r3
	jz	00102$
;	../../../contiki-sensinode//core/net/tcpip.c:119: ret = outputfunc(a);
	mov	dptr,#_outputfunc
	movx	a,@dptr
	push	acc
	inc	dptr
...
;	../../../contiki-sensinode//core/net/tcpip.c:120: return ret;
	mov	r7,dpl
	mov	r6,#0x00
	sjmp	00103$
00102$:
;	../../../contiki-sensinode//core/net/tcpip.c:123: return 0;
	mov	dpl,#0x00
00103$:
...
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/tcpip.c:127: tcpip_set_outputfunc(uint8_t (*f)(uip_lladdr_t *))
;	-----------------------------------------
...
_tcpip_set_outputfunc:
	...
	mov	a,r7
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:129: outputfunc = f;
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
...
;	-----------------------------------------
_packet_input:
;	../../../contiki-sensinode//core/net/tcpip.c:207: if(uip_len > 0) {
	mov	dptr,#_uip_len
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	orl	a,r6
	jz	00105$
;	../../../contiki-sensinode//core/net/tcpip.c:208: check_for_tcp_syn();
	mov	r0,#_check_for_tcp_syn
	mov	r1,#(_check_for_tcp_syn >> 8)
	mov	r2,#(_check_for_tcp_syn >> 16)
	lcall	__sdcc_banked_call
;	../../../contiki-sensinode//core/net/tcpip.c:209: uip_input();
	mov	dpl,#0x01
	mov	r0,#_uip_process
	mov	r1,#(_uip_process >> 8)
	mov	r2,#(_uip_process >> 16)
	lcall	__sdcc_banked_call
;	../../../contiki-sensinode//core/net/tcpip.c:210: if(uip_len > 0) {
	mov	dptr,#_uip_len
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	orl	a,r6
	jz	00105$
;	../../../contiki-sensinode//core/net/tcpip.c:215: tcpip_ipv6_output();
...
_udp_broadcast_new:
	...
	mov	a,sp
	add	a,#0x10
;	../../../contiki-sensinode//core/net/tcpip.c:333: uip_create_linklocal_allnodes_mcast(&addr);
	mov	sp,a
	add	a,#0xF1
	mov	r0,a
	mov	@r0,#0xFF
...
;	../../../contiki-sensinode//core/net/tcpip.c:427: etimer_expired(&periodic)) {
	...
	lcall	__sdcc_banked_call
00106$:
;	../../../contiki-sensinode//core/net/tcpip.c:479: if(data == &uip_ds6_timer_periodic &&
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	...
	sjmp	00123$
00158$:
;	../../../contiki-sensinode//core/net/tcpip.c:480: etimer_expired(&uip_ds6_timer_periodic)) {
	...
	orl	a,b
	jz	00123$
;	../../../contiki-sensinode//core/net/tcpip.c:481: uip_ds6_periodic();
	mov	r0,#_uip_ds6_periodic
	mov	r1,#(_uip_ds6_periodic >> 8)
	mov	r2,#(_uip_ds6_periodic >> 16)
	lcall	__sdcc_banked_call
;	../../../contiki-sensinode//core/net/tcpip.c:482: tcpip_ipv6_output();
	mov	r0,#_tcpip_ipv6_output
	mov	r1,#(_tcpip_ipv6_output >> 8)
	mov	r2,#(_tcpip_ipv6_output >> 16)
	lcall	__sdcc_banked_call
...
;	../../../contiki-sensinode//core/net/tcpip.c:508: uip_udp_periodic_conn(data);
	...
	mov	r2,#(_uip_process >> 16)
	lcall	__sdcc_banked_call
;	../../../contiki-sensinode//core/net/tcpip.c:510: tcpip_ipv6_output();
	mov	r0,#_tcpip_ipv6_output
	mov	r1,#(_tcpip_ipv6_output >> 8)
	mov	r2,#(_tcpip_ipv6_output >> 16)
	lcall	__sdcc_banked_call
...
;	../../../contiki-sensinode//core/net/tcpip.c:538: uip_len = 0;
	mov	dptr,#_uip_len
;	../../../contiki-sensinode//core/net/tcpip.c:540: uip_ext_len = 0;
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;nexthop                   Allocated with name '_tcpip_ipv6_output_nexthop_1_1'
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/tcpip.c:546: tcpip_ipv6_output(void)
;	-----------------------------------------
...
_tcpip_ipv6_output:
	...
	add	a,#0x04
	mov	sp,a
;	../../../contiki-sensinode//core/net/tcpip.c:551: if(uip_len == 0) {
	mov	dptr,#_uip_len
	movx	a,@dptr
	mov	r6,a
	inc	dptr
	...
	orl	a,r6
	jnz	00102$
;	../../../contiki-sensinode//core/net/tcpip.c:552: return;
	ljmp	00139$
00102$:
;	../../../contiki-sensinode//core/net/tcpip.c:555: if(uip_len > UIP_LINK_MTU) {
	clr	c
	clr	a
	subb	a,r6
	mov	a,#0x05
	subb	a,r7
	jnc	00104$
;	../../../contiki-sensinode//core/net/tcpip.c:557: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:558: return;
	ljmp	00139$
00104$:
;	../../../contiki-sensinode//core/net/tcpip.c:561: if(uip_is_addr_unspecified(&UIP_IP_BUF->destipaddr)){
	mov	r6,#_uip_aligned_buf
	mov	r7,#(_uip_aligned_buf >> 8)
	mov	a,#0x18
	add	a,r6
...
00184$:
	...
	orl	a,r6
	jnz	00106$
;	../../../contiki-sensinode//core/net/tcpip.c:563: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:564: return;
	ljmp	00139$
00106$:
;	../../../contiki-sensinode//core/net/tcpip.c:567: if(!uip_is_addr_mcast(&UIP_IP_BUF->destipaddr)) {
	mov	r6,#_uip_aligned_buf
	mov	r7,#(_uip_aligned_buf >> 8)
	mov	a,#0x18
	add	a,r6
	...
	ljmp	00138$
00191$:
;	../../../contiki-sensinode//core/net/tcpip.c:569: nbr = NULL;
	mov	dptr,#_tcpip_ipv6_output_nbr_1_1
	clr	a
	movx	@dptr,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:570: if(uip_ds6_is_addr_onlink(&UIP_IP_BUF->destipaddr)){
	mov	r6,#_uip_aligned_buf
	mov	r7,#(_uip_aligned_buf >> 8)
	mov	a,#0x18
	add	a,r6
	...
	mov	a,dpl
	jz	00120$
;	../../../contiki-sensinode//core/net/tcpip.c:571: nexthop = &UIP_IP_BUF->destipaddr;
	mov	r6,#_uip_aligned_buf
	mov	r7,#(_uip_aligned_buf >> 8)
	mov	a,#0x18
	add	a,r6
	...
	addc	a,r7
	mov	r7,a
	mov	dptr,#_tcpip_ipv6_output_nexthop_1_1
	mov	a,r6
	movx	@dptr,a
	inc	dptr
	mov	a,r7
	...
	sjmp	00121$
00120$:
;	../../../contiki-sensinode//core/net/tcpip.c:574: locrt = uip_ds6_route_lookup(&UIP_IP_BUF->destipaddr);
	mov	r6,#_uip_aligned_buf
	mov	r7,#(_uip_aligned_buf >> 8)
	mov	a,#0x18
	add	a,r6
	...
	mov	r6,dph
	mov	r7,b
;	../../../contiki-sensinode//core/net/tcpip.c:575: if(locrt == NULL) {
	mov	a,r5
	orl	a,r6
	jnz	00117$
;	../../../contiki-sensinode//core/net/tcpip.c:576: if((nexthop = uip_ds6_defrt_choose()) == NULL) {
	...
	orl	a,r3
	jnz	00121$
;	../../../contiki-sensinode//core/net/tcpip.c:591: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:592: return;
	ljmp	00139$
00117$:
;	../../../contiki-sensinode//core/net/tcpip.c:595: nexthop = &locrt->nexthop;
	mov	dptr,#_tcpip_ipv6_output_nexthop_1_1
	mov	a,#0x13
	add	a,r5
	movx	@dptr,a
	...
	movx	@dptr,a
00121$:
;	../../../contiki-sensinode//core/net/tcpip.c:605: if(rpl_update_header_final(nexthop)) {
	mov	dptr,#_tcpip_ipv6_output_nexthop_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	orl	a,b
	jz	00123$
;	../../../contiki-sensinode//core/net/tcpip.c:606: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:607: return;
	ljmp	00139$
00123$:
;	../../../contiki-sensinode//core/net/tcpip.c:610: if((nbr = uip_ds6_nbr_lookup(nexthop)) == NULL) {
	mov	dptr,#_tcpip_ipv6_output_nexthop_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	ljmp	00135$
00196$:
;	../../../contiki-sensinode//core/net/tcpip.c:611: if((nbr = uip_ds6_nbr_add(nexthop, NULL, 0, NBR_INCOMPLETE)) == NULL) {
	mov	dptr,#_tcpip_ipv6_output_nexthop_1_1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	orl	a,r3
	jnz	00128$
;	../../../contiki-sensinode//core/net/tcpip.c:612: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:613: return;
	ljmp	00139$
00128$:
;	../../../contiki-sensinode//core/net/tcpip.c:628: if(uip_ds6_is_my_addr(&UIP_IP_BUF->srcipaddr)){
	...
	orl	a,r3
	jz	00125$
;	../../../contiki-sensinode//core/net/tcpip.c:629: uip_nd6_ns_output(&UIP_IP_BUF->srcipaddr, NULL, &nbr->ipaddr);
	mov	dptr,#_tcpip_ipv6_output_nbr_1_1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	sjmp	00126$
00125$:
;	../../../contiki-sensinode//core/net/tcpip.c:631: uip_nd6_ns_output(NULL, NULL, &nbr->ipaddr);
	mov	dptr,#_tcpip_ipv6_output_nbr_1_1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
...
00199$:
	...
	mov	sp,a
00126$:
;	../../../contiki-sensinode//core/net/tcpip.c:634: stimer_set(&nbr->sendns, uip_ds6_if.retrans_timer / 1000);
	...
	add	a,#0xfc
	mov	sp,a
;	../../../contiki-sensinode//core/net/tcpip.c:635: nbr->nscount = 1;
	mov	dptr,#_tcpip_ipv6_output_nbr_1_1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	ljmp	00138$
00135$:
;	../../../contiki-sensinode//core/net/tcpip.c:638: if(nbr->state == NBR_INCOMPLETE) {
	mov	a,#0x2D
	add	a,r5
	mov	r2,a
	clr	a
	...
	mov	a,@r0
	jnz	00131$
;	../../../contiki-sensinode//core/net/tcpip.c:648: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:649: return;
	ljmp	00139$
00131$:
;	../../../contiki-sensinode//core/net/tcpip.c:653: if(nbr->state == NBR_STALE) {
	mov	a,sp
	add	a,#0xfd
	mov	r0,a
	cjne	@r0,#0x02,00133$
;	../../../contiki-sensinode//core/net/tcpip.c:654: nbr->state = NBR_DELAY;
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	mov	a,#0x03
	lcall	__gptrput
;	../../../contiki-sensinode//core/net/tcpip.c:655: stimer_set(&nbr->reachable, UIP_ND6_DELAY_FIRST_PROBE_TIME);
	mov	a,#0x19
	add	a,r5
	mov	r5,a
	clr	a
	...
	add	a,#0xfc
	mov	sp,a
;	../../../contiki-sensinode//core/net/tcpip.c:656: nbr->nscount = 0;
	mov	dptr,#_tcpip_ipv6_output_nbr_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	lcall	__gptrput
00133$:
;	../../../contiki-sensinode//core/net/tcpip.c:660: tcpip_output(&nbr->lladdr);
	mov	dptr,#_tcpip_ipv6_output_nbr_1_1
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	lcall	__sdcc_banked_call
;	../../../contiki-sensinode//core/net/tcpip.c:677: uip_len = 0;
	mov	dptr,#_uip_len
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/tcpip.c:678: return;
	sjmp	00139$
00138$:
;	../../../contiki-sensinode//core/net/tcpip.c:683: tcpip_output(NULL);
	mov	dptr,#0x0000
	mov	b,#0x00
	mov	r0,#_tcpip_output
	mov	r1,#(_tcpip_output >> 8)
	mov	r2,#(_tcpip_output >> 16)
	lcall	__sdcc_banked_call
;	../../../contiki-sensinode//core/net/tcpip.c:684: uip_len = 0;
	mov	dptr,#_uip_len
;	../../../contiki-sensinode//core/net/tcpip.c:685: uip_ext_len = 0;
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
...
;	../../../contiki-sensinode//core/net/tcpip.c:712: ts = &uip_conn->appstate;
	mov	dptr,#_tcpip_uipcall_ts_1_1
	mov	a,#0x28
	add	a,r5
	movx	@dptr,a
	clr	a
...
;	../../../contiki-sensinode//core/net/tcpip.c:776: uip_init();
	...
	mov	r2,#(_uip_init >> 16)
	lcall	__sdcc_banked_call
;	../../../contiki-sensinode//core/net/tcpip.c:782: rpl_init();
	mov	r0,#_rpl_init
	mov	r1,#(_rpl_init >> 8)
	mov	r2,#(_rpl_init >> 16)
	lcall	__sdcc_banked_call
