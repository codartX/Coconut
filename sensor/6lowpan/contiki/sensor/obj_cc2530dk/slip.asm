...
;------------------------------------------------------------
;blen                      Allocated to stack - sp -11
;outbuf                    Allocated to stack - sp -6
;i                         Allocated to registers r3 r4 
...
;	../../../contiki-sensinode//core/dev/slip.c:265: uip_len = slip_poll_handler(&uip_buf[UIP_LLH_LEN],
	...
	mov	a,r4
	movx	@dptr,a
;	../../../contiki-sensinode//core/dev/slip.c:302: if(uip_len > 0) {
	mov	a,r3
	orl	a,r4
	jz	00114$
;	../../../contiki-sensinode//core/dev/slip.c:303: if(input_callback) {
	mov	dptr,#_input_callback
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	orl	a,r3
	jz	00110$
;	../../../contiki-sensinode//core/dev/slip.c:304: input_callback();
	push	ar7
	push	ar6
	push	ar5
	mov	dptr,#_input_callback
	...
	pop	ar7
00110$:
;	../../../contiki-sensinode//core/dev/slip.c:309: tcpip_input();
	push	ar7
	push	ar6
	push	ar5
	mov	r0,#_tcpip_input
