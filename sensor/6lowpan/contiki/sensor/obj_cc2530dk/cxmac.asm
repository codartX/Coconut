...
; This file was generated Wed Dec  2 18:10:49 2015
;--------------------------------------------------------
	.module cxmac
...
;t                         Allocated to stack - sp -82
;encounter_time            Allocated to stack - sp -80
;strobes                   Allocated to stack - sp -78
;hdr                       Allocated to registers r2 r3 r7 
;got_strobe_ack            Allocated to stack - sp -76
;strobe                    Allocated to stack - sp -74
;strobe_len                Allocated to stack - sp -24
;len                       Allocated to stack - sp -22
;is_broadcast              Allocated to stack - sp -20
;is_dispatch               Allocated to stack - sp -18
;is_strobe_ack             Allocated to registers r2 r5 
;e                         Allocated to stack - sp -16
;packet                    Allocated to stack - sp -13
;is_already_streaming      Allocated to stack - sp -10
