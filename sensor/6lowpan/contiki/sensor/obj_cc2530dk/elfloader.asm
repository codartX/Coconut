...
;------------------------------------------------------------
;offset                    Allocated to stack - sp -6
;buf                       Allocated to stack - sp -9
;len                       Allocated to stack - sp -11
;fd                        Allocated to stack - sp -1
;------------------------------------------------------------
...
;s                         Allocated to stack - sp -56
;a                         Allocated to registers r4 r5 
;name                      Allocated to stack - sp -40
...
;------------------------------------------------------------
;section                   Allocated to stack - sp -87
;size                      Allocated to stack - sp -89
;sectionaddr               Allocated to stack - sp -91
;sectionbase               Allocated to stack - sp -94
;strs                      Allocated to stack - sp -96
;strtab                    Allocated to stack - sp -98
;symtab                    Allocated to stack - sp -100
;symtabsize                Allocated to stack - sp -102
;using_relas               Allocated to stack - sp -103
;fd                        Allocated to stack - sp -82
;rela                      Allocated to stack - sp -80
;rel_size                  Allocated to stack - sp -68
;s                         Allocated to stack - sp -66
...
;------------------------------------------------------------
;fd                        Allocated to stack - sp -229
;ehdr                      Allocated to stack - sp -227
;shdr                      Allocated to stack - sp -175
;strtable                  Allocated to stack - sp -135
;strs                      Allocated to stack - sp -95
;shdrptr                   Allocated to stack - sp -93
;nameptr                   Allocated to registers r3 r4 
;name                      Allocated to stack - sp -91
;i                         Allocated to stack - sp -79
;shdrnum                   Allocated to stack - sp -77
;shdrsize                  Allocated to stack - sp -75
;using_relas               Allocated to stack - sp -73
;textoff                   Allocated to stack - sp -72
;textsize                  Allocated to stack - sp -70
;textrelaoff               Allocated to registers r2 r5 
;textrelasize              Allocated to stack - sp -38
;dataoff                   Allocated to stack - sp -68
;datasize                  Allocated to stack - sp -40
;datarelaoff               Allocated to stack - sp -58
;datarelasize              Allocated to stack - sp -42
;rodataoff                 Allocated to stack - sp -66
;rodatasize                Allocated to stack - sp -44
;rodatarelaoff             Allocated to stack - sp -56
;rodatarelasize            Allocated to stack - sp -52
;symtaboff                 Allocated to stack - sp -64
;symtabsize                Allocated to stack - sp -62
;strtaboff                 Allocated to stack - sp -60
;strtabsize                Allocated to stack - sp -48
;bsssize                   Allocated to stack - sp -54
;process                   Allocated to registers r5 r6 r7 
;ret                       Allocated to registers r6 r7 
;sloc0                     Allocated to stack - sp -58
;sloc1                     Allocated to stack - sp -56
;sloc2                     Allocated to stack - sp -54
;sloc3                     Allocated to stack - sp -52
;sloc4                     Allocated to stack - sp -49
;sloc5                     Allocated to stack - sp -48
;sloc6                     Allocated to stack - sp -44
;sloc7                     Allocated to stack - sp -42
;sloc8                     Allocated to stack - sp -40
;sloc9                     Allocated to stack - sp -38
;sloc10                    Allocated to stack - sp -9
;sloc11                    Allocated to stack - sp -36
;sloc12                    Allocated to stack - sp -35
;sloc13                    Allocated to stack - sp -34
;sloc14                    Allocated to stack - sp -33
;sloc15                    Allocated to stack - sp -32
;sloc16                    Allocated to stack - sp -31
;sloc17                    Allocated to stack - sp -30
;sloc18                    Allocated to stack - sp -29
;sloc19                    Allocated to stack - sp -28
;sloc20                    Allocated to stack - sp -27
;sloc21                    Allocated to stack - sp -26
;sloc22                    Allocated to stack - sp -25
;sloc23                    Allocated to stack - sp -24
;sloc24                    Allocated to stack - sp -23
;sloc25                    Allocated to stack - sp -22
;sloc26                    Allocated to stack - sp -21
;sloc27                    Allocated to stack - sp -20
;sloc28                    Allocated to stack - sp -19
;sloc29                    Allocated to stack - sp -18
;sloc30                    Allocated to stack - sp -17
;sloc31                    Allocated to stack - sp -16
;sloc32                    Allocated to stack - sp -15
;sloc33                    Allocated to stack - sp -14
;sloc34                    Allocated to stack - sp -13
;sloc35                    Allocated to stack - sp -12
;sloc36                    Allocated to stack - sp -11
;sloc37                    Allocated to stack - sp -10
;sloc38                    Allocated to stack - sp -9
;sloc39                    Allocated to stack - sp -8
;sloc40                    Allocated to stack - sp -7
;sloc41                    Allocated to stack - sp -6
;sloc42                    Allocated to stack - sp -5
;sloc43                    Allocated to stack - sp -4
;sloc44                    Allocated to stack - sp -3
;------------------------------------------------------------
