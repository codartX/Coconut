...
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/resolv.c:84: void resolv_conf(const uip_ipaddr_t *dnsserver) { }
;	-----------------------------------------
...
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/resolv.c:85: uip_ipaddr_t *resolv_getserver(void) { return NULL; }
;	-----------------------------------------
...
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/resolv.c:86: uip_ipaddr_t *resolv_lookup(const char *name) { return NULL; }
;	-----------------------------------------
...
;name                      Allocated to registers 
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/resolv.c:87: void resolv_query(const char *name) { }
;	-----------------------------------------
...
;------------------------------------------------------------
;	../../../contiki-sensinode//core/net/resolv.c:89: PROCESS_THREAD(resolv_process, ev, data)
;	-----------------------------------------
;	 function process_thread_resolv_process
;	-----------------------------------------
_process_thread_resolv_process:
;	../../../contiki-sensinode//core/net/resolv.c:91: PROCESS_BEGIN();
	mov	r5,dpl
	mov	r6,dph
	mov	r7,b
	lcall	__gptrget
	...
	cjne	r3,#0x00,00102$
	cjne	r4,#0x00,00102$
;	../../../contiki-sensinode//core/net/resolv.c:92: resolv_event_found = process_alloc_event();
	push	ar7
	push	ar6
	push	ar5
	...
	movx	@dptr,a
;	../../../contiki-sensinode//core/net/resolv.c:93: PROCESS_END();
00102$:
	mov	dpl,r5
	mov	dph,r6
	mov	b,r7
