...
_cc2530_rf_set_addr:
	mov	r6,dpl
	mov	r7,dph
;	../../../contiki-sensinode//cpu/cc253x/dev/cc2530-rf.c:151: for(i = (RIMEADDR_SIZE - 1); i >= 0; --i) {
	mov	r4,#0x07
	mov	r5,#0x00
00101$:
	mov	a,r5
	jb	acc.7,00104$
;	../../../contiki-sensinode//cpu/cc253x/dev/cc2530-rf.c:152: ((uint8_t *)&EXT_ADDR0)[i] = rimeaddr_node_addr.u8[RIMEADDR_SIZE - 1 - i];
	mov	a,r4
	add	a,#_EXT_ADDR0
	mov	r2,a
	mov	a,r5
