...
;	../../../contiki-sensinode//core/net/mac/framer-802154.c:110: packetbuf_set_attr(PACKETBUF_ATTR_MAC_SEQNO, frame.seq);
	...
	dec	sp
00108$:
;	../../../contiki-sensinode//core/net/mac/framer-802154.c:122: frame.fcf.src_addr_mode = FRAME802154_LONGADDRMODE;
...
;	../../../contiki-sensinode//core/net/mac/framer-802154.c:137: rimeaddr_copy((rimeaddr_t *)&frame.dest_addr,
	...
	dec	sp
	dec	sp
;	../../../contiki-sensinode//core/net/mac/framer-802154.c:143: frame.fcf.dest_addr_mode = FRAME802154_LONGADDRMODE;
	mov	dptr,#(_frame + 0x0005)
	mov	a,#0x03
	movx	@dptr,a
00111$:
