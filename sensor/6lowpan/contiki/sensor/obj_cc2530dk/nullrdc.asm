...
_received_seqnos:
	.ds 144
_send_packet_is_broadcast_1_1:
	.ds 2
_send_packet_dsn_1_1:
	.ds 1
_send_packet_wt_1_1:
	.ds 2
_send_packet_ackbuf_1_1:
	.ds 3
;--------------------------------------------------------
...
;is_broadcast              Allocated with name '_send_packet_is_broadcast_1_1'
;dsn                       Allocated with name '_send_packet_dsn_1_1'
;wt                        Allocated with name '_send_packet_wt_1_1'
;ackbuf                    Allocated with name '_send_packet_ackbuf_1_1'
;------------------------------------------------------------
...
;	../../../contiki-sensinode//core/net/mac/nullrdc.c:133: is_broadcast = rimeaddr_cmp(packetbuf_addr(PACKETBUF_ADDR_RECEIVER),
	...
	dec	sp
	dec	sp
	mov	dptr,#_send_packet_is_broadcast_1_1
	mov	a,r6
	movx	@dptr,a
	inc	dptr
	mov	a,r7
...
;	../../../contiki-sensinode//core/net/mac/nullrdc.c:168: len = NETSTACK_RADIO.read(ackbuf, ACK_LEN);
	...
	push	ar6
	push	ar7
	mov	dptr,#_send_packet_ackbuf_1_1
	mov	b,#0x00
	pop	ar2
	pop	ar1
	pop	ar0
...
;	../../../contiki-sensinode//core/net/mac/nullrdc.c:169: if(len == ACK_LEN && ackbuf[2] == dsn) {
	cjne	r5,#0x03,00109$
	mov	dptr,#(_send_packet_ackbuf_1_1 + 0x0002)
	movx	a,@dptr
	mov	r7,a
	mov	dptr,#_send_packet_dsn_1_1
	movx	a,@dptr
