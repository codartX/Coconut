...
;value                     Allocated to stack - sp -16
;tmp                       Allocated to registers r6 r7 
;zero                      Allocated to stack - sp -14
...
_uiplib_ip6addrconv:
	...
	mov	a,sp
	add	a,#0x11
;	../../../contiki-sensinode//core/net/uiplib.c:50: char c = 0;  //gcc warning if not initialized
	mov	sp,a
	add	a,#0xf6
	mov	r0,a
	mov	@r0,#0x00
...
_uiplib_ipaddrconv:
	...
	mov	r6,dph
	mov	r7,b
;	../../../contiki-sensinode//core/net/uiplib.c:146: return uiplib_ip6addrconv(addrstr, ipaddr);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	a,@r0
