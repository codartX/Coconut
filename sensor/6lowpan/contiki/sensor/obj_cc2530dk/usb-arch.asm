...
;flag                      Allocated to stack - sp -6
;res                       Allocated to registers r7 
;ep                        Allocated to stack - sp -5
;sloc0                     Allocated to stack - sp -2
;------------------------------------------------------------
...
;ei                        Allocated to registers r5 
;flag                      Allocated to registers r7 
;ep                        Allocated to registers r4 r3 r6 
...
;data_end                  Allocated to stack - sp -6
;res                       Allocated to stack - sp -5
;copy                      Allocated to stack - sp -4
;sloc0                     Allocated to stack - sp -2
;------------------------------------------------------------
...
;------------------------------------------------------------
;ep_hw                     Allocated to stack - sp -14
;len                       Allocated to stack - sp -13
;res                       Allocated to stack - sp -11
;ep                        Allocated to registers r4 r3 r5 
;copy                      Allocated to stack - sp -10
