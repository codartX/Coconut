...
;num_transmissions         Allocated to stack - sp -1
...
;adata                     Allocated to stack - sp -10
...
;current_off_time          Allocated to registers r5 r6 
;sloc0                     Allocated to stack - sp +4
;sloc1                     Allocated to stack - sp -2
;------------------------------------------------------------
...
;------------------------------------------------------------
;ptr                       Allocated to stack - sp -32
;sent                      Allocated to stack - sp -26
...
;ackbuf                    Allocated to stack - sp -6
...
;------------------------------------------------------------
;hdr                       Allocated to stack - sp -30
;reception_time            Allocated to registers 
;ret                       Allocated to registers 
;adata                     Allocated to stack - sp -12
;i                         Allocated to stack - sp -10
;receiver                  Allocated to stack - sp -7
